...
const multiPresentation: any = {
  ...
  verifiableCredential: [
    {
      ...
      type: ["VerifiableCredential", "GS1PrefixLicenceCredential"],
      issuer: {
      ...
      proof: {
        ...
        proofValue:
          "z4GKxTZzba6B4Bs2vCETRi3frX9vFn9m61ZsNKPaxH9yZBX382DLGY1yRvuKgwbxUag88eJQfALuBdBHhp3m2r5nA",
      },
    },
    {
      "@context": [
      ...
      proof: {
        ...
        verificationMethod:
          "did:web:ssi.eecc.de#z6MkoHWsmSZnHisAxnVdokYHnXaVqWFZ4H33FnNg13zyymxd",
        proofValue:
          "zmwT31nYTHhecy594pxMCMmuidTAEWsPSZsXAYj84bQfGSDUD8z5uCNy6WfyqwnkG58YQiZAYjevMdw6nBZaPTJ6",
      },
    },
  ],
  ...
  proof: {
    ...
    challenge: "12345",
    proofValue:
      "z2aP6o5AeB9sD6N1H26X6bvwcLPjeRpAvBhYo6xixYX7AvieVNFH4K6brZxhdKnXCw7BKYnhf7wfqQTrmGugwL5hr",
  },
};
...
const domainPresentation: any = {
  ...
  verifiableCredential: [
    {
      ...
      proof: {
        ...
        verificationMethod:
          "did:web:ssi.eecc.de#z6MkoHWsmSZnHisAxnVdokYHnXaVqWFZ4H33FnNg13zyymxd",
        proofValue:
          "z5ti1RiEYjrc9177Cfir2jkmezMcBWr5GmeLo2MGaqoPcqxK8cRpg6Sx9WVMyDDGBNxkJPswTK9vaERhJLYD8jyLY",
      },
    },
  ],
  holder: "did:web:ssi.eecc.de",
  proof: {
    ...
    proofValue:
      "z3tHBT6WT7dgULQiEH6CDdp3izjVCQUVGY1XSzMHMUq4PoPg3HnsYSFnkbdJsp1zE6yYUXkzfy4ceFM6qHpS7LTxk",
  },
};
...
const statusPresentation: any = {
  ...
  verifiableCredential: [
    {
      ...
      type: ["VerifiableCredential", "EECCAccessCredential"],
      issuer: {
        id: "did:web:ssi.eecc.de",
        image: "https://id.eecc.de/assets/img/logo_big.png",
        name: "EECC",
      ...
      credentialStatus: {
        ...
        revocationListCredential:
          "https://ssi.eecc.de/api/registry/vc/status/did:web:ssi.eecc.de/1",
      },
      credentialSubject: {
      ...
      proof: {
        ...
        verificationMethod:
          "did:web:ssi.eecc.de#z6MkoHWsmSZnHisAxnVdokYHnXaVqWFZ4H33FnNg13zyymxd",
        proofValue:
          "z247VYAm5GbG1sAAcqW7QwEL1mfXxaSa3N93EuLc4HeTUm219UjrPMC5gyq5xTAaDQCVMUEVTouyboY4UMTxzjekN",
      },
    },
  ],
  holder: "did:web:ssi.eecc.de",
  proof: {
    ...
    proofValue:
      "z3BCT7df4bRXXTa9i79apmiou76M8LVZXGFYHA18xT6wX3PfcpjfWaMc9xhFwmGi9XTj8tth1ai1ASeQoHiGWMn1V",
  },
};
...
describe("Verifier API Test for Presentations", () => {
  ...
  test("Verify single presentation with challenge", async () => {
    const res = await request(server)
      .post("/api/verifier")
      .query({ challenge: "12345" })
      .send([multiPresentation]);
    expect(res.statusCode).toEqual(200);
    expect(res.body[0]).toHaveProperty("verified");
    expect(res.body[0].verified).toBe(true);
    expect(res.body[0]).toHaveProperty("credentialResults");
  ...
  test("Verify single presentation with challenge & domain", async () => {
    const res = await request(server)
      .post("/api/verifier")
      .query({ challenge: "12345", domain: "ssi.eecc.de/verifier" })
      .send([domainPresentation]);
    expect(res.statusCode).toEqual(200);
    expect(res.body[0]).toHaveProperty("verified");
    expect(res.body[0].verified).toBe(true);
    expect(res.body[0]).toHaveProperty("credentialResults");
  ...
  test("Falsify single presentation with wrong challenge", async () => {
    const res = await request(server)
      .post("/api/verifier")
      .query({ challenge: "falseChallenge", domain: "ssi.eecc.de/verifier" })
      .send([domainPresentation]);
    expect(res.statusCode).toEqual(200);
    expect(res.body[0]).toHaveProperty("verified");
